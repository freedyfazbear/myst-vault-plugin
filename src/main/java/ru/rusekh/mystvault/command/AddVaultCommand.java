...
public class AddVaultCommand implements CommandExecutor
{
    private final MystVaultPlugin vaultPlugin;

    public AddVaultCommand(MystVaultPlugin vaultPlugin) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        serverData.getDisallowedItems().add(itemStack);
        serverData.save();

        ChatHelper.sendMessage(player, "&aSuccessfully disallowed the " + itemStack.getType().name());
